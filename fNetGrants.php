<?php
/**/
function chkPrivileged($ip=null){
/* Возвращает true, если указанный адрес находится в белом списке 
$grantsAddrList из params.php, или не находится в чёрном.

Если не указано $ip, то $ip - адрес, с которого обратились к скрипту,
*/
