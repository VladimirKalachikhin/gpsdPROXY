...
![collision model](screenshots/s1.jpeg)<br>  
 Object `{"class":"ALARM","alarms":{"collisions":[]}}` contains a list of mmsi and position of vessels that have a risk of collision. The [GaladrielMap](https://hub.mos.ru/v.kalachihin/GaladrielMap) highlights such vessels on the map and indicates the direction to them on self cursor.  
